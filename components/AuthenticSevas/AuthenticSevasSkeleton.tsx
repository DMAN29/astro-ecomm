...
const AuthenticSevasSkeleton: React.FC = () => {
  return (
    <div className="py-6 md:py-8 md:h-screen md:flex md:flex-col md:justify-center">
      ...
      <div className="relative max-w-4xl mx-auto px-4 w-full">
        ...
        {/* OM Symbol Skeleton */}
        <div className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 hidden md:block z-10 bg-background p-2">
        ...
        <div className="space-y-6 md:space-y-12 pt-4">
          {[1, 2, 3, 4].map((_, index) => (
            ...
            >
              <div
                className={`flex-1 flex ${index % 2 === 0 ? "justify-end" : "justify-start"}`}
              >
                <div
